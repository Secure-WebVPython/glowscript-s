;(function () {
    ...
    */
    ...
    var poptions = {place:$('body'), width:'100%', height:'100%', readonly:true, pos:"bottom", digits:6}
    ...
    function print(args) { // similar to Python print()
    	...
    	if (printarea === null) { // need to make a new printarea
            ...
            container.css('height', '99%').css('background','white')
            container.appendTo($("#printer"))    // default is $('body'), below canvas (2.7)
            window.__context.print_container = container
            printarea = $('<textarea id=print spellcheck="false"/>').appendTo(container).css('font-family', 'Verdana', 'Sans-Serif').css('font-size', '100%').css('height', '100%').css('border','none').css('padding', '0').css('margin-left','5px')
            modify_printarea()
    	}
